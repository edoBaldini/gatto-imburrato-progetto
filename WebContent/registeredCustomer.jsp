		...
		<h:form>
			...
			<h:form styleClass="form col-md-12 center-block">
				<div class="form-group">Firstname:
					${customerController.newCustomer.firstname}</div>
				<div class="form-group">Lastname:
					${customerController.newCustomer.lastname}</div>
				<div class="form-group">Email:
					${customerController.newCustomer.email}</div>
				<div class="form-group">Password:
					${customerController.newCustomer.password}</div>
				<div class="form-group">Phone number:
					${customerController.newCustomer.phonenumber}</div>	
				<div class="form-gruop">Address:
					${customerController.newCustomer.address}</div>
			</h:form>
	</div>
	</h:form>
	</f:view>
